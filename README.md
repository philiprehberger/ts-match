...
[![CI](https://github.com/philiprehberger/match-ts/actions/workflows/ci.yml/badge.svg)](https://github.com/philiprehberger/match-ts/actions/workflows/ci.yml)
[![npm version](https://img.shields.io/npm/v/@philiprehberger/match-ts.svg)](https://www.npmjs.com/package/@philiprehberger/match-ts)
[![Last updated](https://img.shields.io/github/last-commit/philiprehberger/match-ts)](https://github.com/philiprehberger/match-ts/commits/main)
...
⭐ [Star the repo](https://github.com/philiprehberger/match-ts)

🐛 [Report issues](https://github.com/philiprehberger/match-ts/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

💡 [Suggest features](https://github.com/philiprehberger/match-ts/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
